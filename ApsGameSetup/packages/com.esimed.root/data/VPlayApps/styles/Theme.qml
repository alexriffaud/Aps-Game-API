...
Item {
  ...
  readonly property bool isWasm: false
  ...
  property ThemeNavigationTabControl navigationTabBar: ThemeNavigationTabControl { }
  ...
  property ThemeAppRadio appRadio: ThemeAppRadio { }
